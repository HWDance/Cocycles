...
def run_experiment(seed,estimator,splits,bootstrap,cocycle,width,weight_decay):
    ...
    if estimator == "S-estimator":
        ...
        for k in range(splits):
            ...
            print((EY1test-EY0test))
            v_ATE_DR = (EY1test-EY0test)
            v_ATT_DR = (Ytest[:,0]-EY0test)[treated_test]
            ...
            v_ATT_DR += ((weights0[k]*Probs)[:,0]*(EY0test-Ytest[:,0]))[treated_test]
    ...
    results = {"seed" : seed,
               "name": name,
               "ATE_PI" : ATE_PI,
               "Var_ATE_PI" : Var_ATE_PI,
               "ATE_PI_term" : ATE_PI_term,
               "ATE_IPW" : ATE_IPW,
               "ATE_DR" : ATE_DR,
               "ATE_sq_DR" : ATE_sq_DR,
               "ATT_PI" : ATT_PI,
               "Var_ATT_PI" : Var_ATT_PI,

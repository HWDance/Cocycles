...
def run(seed, n=None, m=None, Dist="sqeuclidean", corr = 0.5, affine = True, additive = True, multivariate_noise = False, dist = "laplace"):
    np.random.seed(seed)
    n0 = n1 = n2 = n or 250
    if m is not None:
        n1 = m
    ...
    if not additive:
        ...
        #S0 = np.array([[1.0, 1.0], [1.0, 2.0]])
        #S1 = np.array([[corr**2, corr**2], [corr**2, corr**2 + 1.0]])
        #S2 = np.array([[1/corr**2, 1/corr**2], [1/corr**2, 1/corr**2 + 1.0]])
...
if __name__ == "__main__":
    result = run(seed=0, n=500, corr = False, affine = True, multivariate_noise = True)

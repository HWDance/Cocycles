...
n1 = n  # number of points in P1
n2 = n  # number of points in P2

# Define DGP: Gaussian marginals
m0 = np.array([0.0, 0.0])
...
def run(seed, n = None, m = None, epsilon = 0, wrongorder = False):
    ...
    # Sample from the DGP
    P0 = np.random.multivariate_normal(m0, S0, size=n0)
    P1 = np.random.multivariate_normal(m1, S1, size=n1)
    P2 = np.random.multivariate_normal(m2, S2, size=n2)
